		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizonta form-signinl" onsubmit="return receptionLoginValidate()" role="form" action="${pageContext.request.contextPath}/studentLogin" method="post" id="receptionLogin" name="receptionLogin">
